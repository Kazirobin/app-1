...
{/* Small Device Title Bar End */}
    <div className='lg:grid md:grid md:grid-cols-[40px,4fr,2fr,2fr,3fr] md:gap-10 md:justify-items-start md:border-4 sm:grid  grid-cols-[40px,2fr,1fr,1fr,2fr] lg:space-y-0 md:space-y-0 sm:space-y-0    space-y-3'>
        {/*
        <>
        ...
        */}
        <p className='font-bold  lg:grid md:grid sm:grid hidden justify-self-end'>{id+1}</p>
        <p className='text-left'>{name}</p>
        <p className='text-left'>{preparing_time}</p>
        <p className='text-left'>{calories} calories</p>
        <button className=''>
          <h1 className='font-bold bg-lime-400  rounded-full lg:mt-2 py-1 px-4 '>Preparing</h1>
        </button>
